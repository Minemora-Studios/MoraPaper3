...
public class CraftArmorStandMonster extends CraftMonster implements ArmorStandMonster {
    public CraftArmorStandMonster(CraftServer server, net.minecraft.world.entity.monster.ArmorStandMonster entity) {
        super(server, entity);
    }

    @Override
    public net.minecraft.world.entity.monster.ArmorStandMonster getHandle() {
        return (net.minecraft.world.entity.monster.ArmorStandMonster) this.entity;
    }
    ...
    public EulerAngle getBodyPose() {
        return CraftArmorStandMonster.fromNMS(this.getHandle().getBodyPose());
    }

    @Override
    public void setBodyPose(EulerAngle pose) {
        this.getHandle().setBodyPose(CraftArmorStandMonster.toNMS(pose));
    }

    @Override
    public EulerAngle getLeftArmPose() {
        return CraftArmorStandMonster.fromNMS(this.getHandle().getLeftArmPose());
    }

    @Override
    public void setLeftArmPose(EulerAngle pose) {
        this.getHandle().setLeftArmPose(CraftArmorStandMonster.toNMS(pose));
    }

    @Override
    public EulerAngle getRightArmPose() {
        return CraftArmorStandMonster.fromNMS(this.getHandle().getRightArmPose());
    }

    @Override
    public void setRightArmPose(EulerAngle pose) {
        this.getHandle().setRightArmPose(CraftArmorStandMonster.toNMS(pose));
    }

    @Override
    public EulerAngle getLeftLegPose() {
        return CraftArmorStandMonster.fromNMS(this.getHandle().getLeftLegPose());
    }

    @Override
    public void setLeftLegPose(EulerAngle pose) {
        this.getHandle().setLeftLegPose(CraftArmorStandMonster.toNMS(pose));
    }

    @Override
    public EulerAngle getRightLegPose() {
        return CraftArmorStandMonster.fromNMS(this.getHandle().getRightLegPose());
    }

    @Override
    public void setRightLegPose(EulerAngle pose) {
        this.getHandle().setRightLegPose(CraftArmorStandMonster.toNMS(pose));
    }

    @Override
    public EulerAngle getHeadPose() {
        return CraftArmorStandMonster.fromNMS(this.getHandle().getHeadPose());
    }

    @Override
    public void setHeadPose(EulerAngle pose) {
        this.getHandle().setHeadPose(CraftArmorStandMonster.toNMS(pose));
    }
    ...
    public void addDisabledSlots(EquipmentSlot... slots) {
        ...
        setDisabledSlots(disabled.toArray(new EquipmentSlot[0]));
    }
