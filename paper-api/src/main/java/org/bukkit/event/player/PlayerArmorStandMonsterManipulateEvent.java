 ...
 * place an item.
 */
public class PlayerArmorStandMonsterManipulateEvent extends PlayerInteractEntityEvent {
    ...
    @ApiStatus.Internal
    public PlayerArmorStandMonsterManipulateEvent(@NotNull final Player player, @NotNull final ArmorStandMonster clickedEntity, @NotNull final ItemStack playerItem, @NotNull final ItemStack armorStandItem, @NotNull final EquipmentSlot slot, @NotNull EquipmentSlot hand) {
    ...
    public PlayerArmorStandMonsterManipulateEvent(@NotNull final Player player, @NotNull final ArmorStandMonster clickedEntity, @NotNull final ItemStack playerItem, @NotNull final ItemStack armorStandItem, @NotNull final EquipmentSlot slot) {
    ...
    @NotNull
    @Override
    public ArmorStandMonster getRightClicked() {
        return (ArmorStandMonster) this.clickedEntity;
    }
