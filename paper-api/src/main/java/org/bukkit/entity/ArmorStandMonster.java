...
/**
 * Represents a ArmorStandMonster.
 */
public interface ArmorStandMonster extends Monster {
     ...
     * @see #getEquipment()
     * @deprecated prefer {@link ArmorStandMonster#getItem(EquipmentSlot)}
     */
    @NotNull
     ...
     * @see #getEquipment()
     * @deprecated prefer
     * {@link ArmorStandMonster#setItem(EquipmentSlot, ItemStack)}
     */
    @Deprecated(since = "1.15.2")
     ...
     * {@link ArmorStandMonster.LockType locking mechanism}.
     *
     * @param slot the equipment slot to lock
     * @param lockType the LockType to lock the equipment slot with
     */
    void addEquipmentLock(@NotNull EquipmentSlot slot, @NotNull ArmorStandMonster.LockType lockType);

    /**
     * Remove a {@link ArmorStandMonster.LockType locking mechanism}.
     *
     * @param slot the equipment slot to change
     * @param lockType the LockType to remove
     */
    void removeEquipmentLock(@NotNull EquipmentSlot slot, @NotNull ArmorStandMonster.LockType lockType);
     ...
     */
    boolean hasEquipmentLock(@NotNull EquipmentSlot slot, @NotNull ArmorStandMonster.LockType lockType);
    ...
    public enum LockType {
         ...
         * themselves and the ArmorStandMonster.
         */
        ADDING_OR_CHANGING,
        /**
